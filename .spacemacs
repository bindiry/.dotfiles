...
values."
  ...
  (setq-default
   ...
   dotspacemacs-default-font '("M+ 1m light"
                               :size 14
                               :weight normal
                               :width normal
                               :powerline-scale 1.2)
...
you should place your code here."
  ...
  ;; do not replace content when paste
